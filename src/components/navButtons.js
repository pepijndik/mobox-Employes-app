...
export function BackButton({color, onPress}: ButtonProps) {
  return NavButtonBase('navigate-before', onPress, color);
}
export function ForwardButton({color, onPress}: ButtonProps) {
  return NavButtonBase('navigate-next', onPress, color);
}
